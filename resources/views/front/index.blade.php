...
@section('title', 'Creatifolio BuildWithAngga')
@section('content')
            ...
            <div class="flex items-center group/slider flex-nowrap w-max">
                <div
                    ...
                    <div class="flex w-fit h-[40px] shrink-0">
                        <img src="{{ asset('images/logos/logoipsum1.png') }}" class="object-contain w-full h-full"
                            alt="logo">
                    </div>
                    <div class="flex w-fit h-[40px] shrink-0">
                        <img src="{{ asset('images/logos/logoipsum2.png') }}" class="object-contain w-full h-full"
                            alt="logo">
                    </div>
                    <div class="flex w-fit h-[40px] shrink-0">
                        <img src="{{ asset('images/logos/logoipsum3.png') }}" class="object-contain w-full h-full"
                            alt="logo">
                    </div>
                    <div class="flex w-fit h-[40px] shrink-0">
                        <img src="{{ asset('images/logos/logoipsum4.png') }}" class="object-contain w-full h-full"
                            alt="logo">
                    </div>
                    <div class="flex w-fit h-[40px] shrink-0">
                        <img src="{{ asset('images/logos/logoipsum1.png') }}" class="object-contain w-full h-full"
            ...
            <div class="grid grid-cols-2 gap-[30px]">
                <div class="p-[50px] pb-0 rounded-[30px] flex flex-col gap-[50px] bg-[#F4F5F8]">
                    <div class="flex items-center justify-center w-20 h-20 rounded-full shrink-0 bg-portto-purple">
                        <img src="{{ asset('images/icons/crown.svg') }}" class="object-contain w-10 h-10"
                            alt="icon">
                    </div>
                ...
                <div class="col-span-2 p-[50px] pb-0 rounded-[30px] flex gap-[50px] bg-[#F4F5F8]">
                    <div class="flex flex-col gap-[50px]">
                        <div class="flex items-center justify-center w-20 h-20 rounded-full shrink-0 bg-portto-red">
                            <img src="{{ asset('images/icons/3dcube.svg') }}" class="object-contain w-10 h-10"
                                alt="icon">
                        </div>
                        <div class="flex flex-col gap-5">
                        ...
                        @if ($index < 3)
                            <div
                                ...
                                <div class="w-[608px] h-[408px] rounded-[30px] overflow-hidden absolute">
                                    <img src="{{ Storage::url($project->cover) }}" class="object-cover w-full h-full"
                                        alt="thumbnail">
                                </div>
                                <div
